...
BEGIN_MESSAGE_MAP(CNetworkServerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CNetworkServerApp 构造
...
// 唯一的 CNetworkServerApp 对象

CNetworkServerApp theApp;


// CNetworkServerApp 初始化
